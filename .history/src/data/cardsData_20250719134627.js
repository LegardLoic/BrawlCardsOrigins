...
export const cards = [
  ...
  },
  {
    ...
    famille: "Croc-Noir",
    sousFamille : "Terrestre",
    texte: "<br><i>Debut de combat</i><br><br><br><color=red>-1hp</color> à un adversaire <br><br> aléatoire",
  ...
  },
  {
    ...
    famille: "Croc-Noir",
    sousFamille : "Marin",
    texte: "<br><i>Cri</i><br><br><br>Vous obtenez 1 <br><br> <color=white>Poisson gris</color><br><br>",
    carteSpe: 25,
    piocherCarteSpe: true,
  },
  ...
  },
  {
    ...
    famille: "Les Sylphariels",
    sousFamille : "Light",
    texte: "<br><i>Evanescence(Vente)</i> et <br> <br> <color=rgb(20, 33, 220)>Aura</color><br><br><br><color=red>+2hp</color> aux Sylphariels",
    evanescence: (board, draggedCard) => {
        let bonusDoree = 1
        if(draggedCard.estDoree){
            bonusDoree = 2
...

  {
    ...
    deathTrigger: (mortCarte, cartesBoard, self) => {
      // Ne rien faire si la carte morte n’est pas Croc-Noir ou si elle est Grûm lui-même
      if (mortCarte.sousFamille !== "Humain" || mortCarte.id === self.id) return;
        let bonusDoree = 1
        if(self.estDoree){
            bonusDoree = 2
        }
...

  {
    ...
    deathTrigger: (mortCarte, cartesBoard, self) => {
      // Ne rien faire si la carte morte n’est pas Croc-Noir ou si elle est Grûm lui-même
      if (mortCarte.sousFamille !== "Réprouvé" || mortCarte.id === self.id) return;
    
      // Cherche les cibles valides (autres Croc-Noir vivants, excluant Grûm et la carte morte)
      const cibles = cartesBoard.filter(c =>
        c.sousFamille === "Réprouvé" &&
        c.id !== self.id &&
        c.id !== mortCarte.id &&
        c.hp > 0
      );
