...
export async function verifEffetDebutTour(boardPlayer, setBoardPlayer, deck, setDeck, setFusionAnim, bonusAtkElem, bonusHpElem, setBonusAtkElem, setBonusHpElem, shopCards, setShopCards, setAnimAoEVisuelle, sleep){
...
export async function oneTicDebutCombat(cartesSource, cartesCible, setProjectileAnim, sleep) {
...
export async function oneTicPendantCombat(carteMourante, carteCible, cartesCible, setProjectileAnim, sleep) {
    const resultCibles = [...cartesCible];
    const morts = [];
