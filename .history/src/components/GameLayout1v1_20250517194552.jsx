...
export default function GameLayout1v1({AlertModal, ShopHUD, Player2HUDFight, ShopBoard, Player2BoardFight, PlayerBoard, PlayerDeck, PlayerHUD, CardPreview, SynergyHUD}){
    useEffect(() => {
        const updateScale = () => {
