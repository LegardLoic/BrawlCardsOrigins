...
export default function GameLayout1v1({AlertModal, ShopHUD, Player2HUDFight, ShopBoard, Player2BoardFight, PlayerBoard, PlayerDeck, PlayerHUD, CardPreview, SynergyHUD, MusicControl, Player2Board, Player2Deck, Player2HUD, FusionAnim, GriffeEffects}){
    useEffect(() => {
        const updateScale = () => {
